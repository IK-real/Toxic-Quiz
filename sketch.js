...
H.position(425,10)
A=createElement("h1")
A.html("answer these or lose ")
A.position(300,50)
B=createElement("h1")
B.html("Questions ")
B.position(425,100)
C=createElement("h2")
C.html("Q1) Who is Batman")
C.position(50,200)
D=createElement("h2")
D.html("a) Bruce Wyane")
D.position(50,250)
E=createElement("h2")
E.html("b) Bruce Wayne Manor")
E.position(50,300)
G=createElement("h2")
G.html("c) Bruce Wayne The Second")
G.position(50,350)
I=createElement("h2")
I.html("d) Bruce Wayne")
I.position(50,400)
bp=createButton("SUBMIT")
bp.position(100,550)
